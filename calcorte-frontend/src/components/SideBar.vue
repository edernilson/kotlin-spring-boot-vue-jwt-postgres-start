<template>
  <aside class="sidebar border-right d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 250px;">
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item">
        <router-link to="/home" class="nav-link" :class="{'link-dark': this.currentPage !== 'Home'}">
      ...
      <li>
        <router-link to="/projetos" class="nav-link" :class="{'link-dark': this.currentPage !== 'Projetos'}"
                     aria-current="page">
          <svg class="bi me-2" width="16" height="16">
      ...
      <li>
        <router-link to="/clientes" class="nav-link" :class="{'link-dark': this.currentPage !== 'Clientes'}">
          <svg class="bi me-2" width="16" height="16">
      ...
      <li>
        <router-link to="/produtos" class="nav-link" :class="{'link-dark': this.currentPage !== 'Produtos'}">
          <svg class="bi me-2" width="16" height="16">
